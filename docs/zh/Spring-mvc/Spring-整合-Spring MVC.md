...
```
## **配置 Spring MVC**
创建一个名为`spring-mvc.xml`文件来配置MVC
```
...
<beans xmlns="http://www.springframework.org/schema/beans" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <context:component-scan base-package="com.yky.my.shop" use-default-filters="false">
...
<context:component-scan base-package="com.yky.my.shop">
